...
var weekly_quests: Array = []
var monthly_quests: Array = []

var last_daily_refresh: Dictionary = {}
var last_weekly_refresh: Dictionary = {}
var last_monthly_refresh: Dictionary = {}
...
func generate_quest(available_types: Array, quest_period: String, index: int) -> Dictionary:
	...
	return {
		...
		"target": target,
		"current": 0,
		"reward_points": reward_data.points,
...
func get_quest_target(quest_type: int, period: String) -> int:
	...
	var base_targets = {
		...
		GameConstants.QuestType.COMPLETE_WAVES: {"daily": 5, "weekly": 25, "monthly": 250},
		...
		GameConstants.QuestType.REACH_WAVE: {"daily": 10, "weekly": 30, "monthly": 170},
...
func get_quest_reward(period: String) -> Dictionary:
	"""Retorna recompensa baseada no período (pontos de melhoria e diamantes)"""
	match period:
		"daily":
			return {
				"points": GameConstants.QUEST_REWARD_DAILY_POINTS,
				"emeralds": 0,
				"diamonds": 0
			}
		"weekly":
			return {
				"points": GameConstants.QUEST_REWARD_WEEKLY_POINTS,
				"emeralds": 0,
				"diamonds": 0
			}
		"monthly":
			return {
				"points": GameConstants.QUEST_REWARD_MONTHLY_POINTS,
				"emeralds": 0,
...
func claim_quest(quest_id: String) -> Dictionary:
	...
	for quest in all_quests:
		if quest.id == quest_id and quest.status == QuestStatus.COMPLETED:
			...
			return {
				"success": true,
				"reward_points": quest.get("reward_points", 0),
